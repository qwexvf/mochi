...
?DOC(false).
-spec try_or({ok, KTW} | {error, any()}, KUA, fun((KTW) -> KUA)) -> KUA.
...
-spec try_fold_expression(
    glance:expression(),
    KSU,
    fun((KSU, glance:expression()) -> {ok, KSU} | {error, KSV})
) -> {ok, KSU} | {error, KSV}.
...
-spec try_fold_clauses(
    list(glance:clause()),
    KTJ,
    fun((KTJ, glance:expression()) -> {ok, KTJ} | {error, KTK})
) -> {ok, KTJ} | {error, KTK}.
...
-spec try_fold_statements(
    ...
    KSO,
    fun((KSO, glance:expression()) -> {ok, KSO} | {error, KSP})
) -> {ok, KSO} | {error, KSP}.
...
-spec try_fold_fields(
    ...
    KTC,
    fun((KTC, glance:expression()) -> {ok, KTC} | {error, KTD})
) -> {ok, KTC} | {error, KTD}.
...
-spec try_fold_expressions(
    ...
    KTQ,
    fun((KTQ, glance:expression()) -> {ok, KTQ} | {error, KTR})
) -> {ok, KTQ} | {error, KTR}.
