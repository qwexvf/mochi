...
-type definition(FLV) :: {definition, list(attribute()), FLV}.
...
-type bit_string_segment_option(FLW) :: bytes_option |
    int_option |
    float_option |
    bits_option |
    utf8_option |
...
-type record_update_field(FLX) :: {record_update_field,
        binary(),
        gleam@option:option(FLX)}.

-type variant_field() :: {labelled_variant_field, type(), binary()} |
    {unlabelled_variant_field, type()}.

-type field(FLY) :: {labelled_field, binary(), span(), FLY} |
    {shorthand_field, binary(), span()} |
    {unlabelled_field, FLY}.
...
-type parsed_list(FLZ) :: {parsed_list,
        list(FLZ),
        gleam@option:option(FLZ),
        list({glexer@token:token(), glexer:position()}),
        integer()}.

-file("src/glance.gleam", 216).
...
-file("src/glance.gleam", 423).
-spec expect_name(
    list({glexer@token:token(), glexer:position()}),
    fun((binary(), list({glexer@token:token(), glexer:position()})) -> {ok, FMR} |
        {error, error()})
) -> {ok, FMR} | {error, error()}.
...
-file("src/glance.gleam", 1430).
-spec string_offset(integer(), binary()) -> integer().
string_offset(Start, String) ->
    Start + erlang:byte_size(String).

-file("src/glance.gleam", 434).
-spec until(
    glexer@token:token(),
    FMW,
    list({glexer@token:token(), glexer:position()}),
    fun((FMW, list({glexer@token:token(), glexer:position()})) -> {ok,
            {FMW, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {FMW, integer(), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("src/glance.gleam", 1733).
-spec list(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FSP, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    gleam@option:option(fun((span()) -> FSP)),
    list(FSP),
    list({glexer@token:token(), glexer:position()})
) -> {ok, parsed_list(FSP)} | {error, error()}.
...
-file("src/glance.gleam", 1361).
-spec bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FQM, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list(bit_string_segment_option(FQM)),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(FQM)),
            list({glexer@token:token(), glexer:position()})}} |
...
-file("src/glance.gleam", 1351).
-spec optional_bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FQF, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(FQF)),
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("src/glance.gleam", 1341).
-spec bit_string_segment(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FPY, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {{FPY, list(bit_string_segment_option(FPY))},
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("src/glance.gleam", 1690).
-spec delimited(
    list(FSF),
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FSF, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok, {list(FSF), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("src/glance.gleam", 1886).
-spec comma_delimited(
    list(FTH),
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FTH, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok,
        {list(FTH), integer(), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("src/glance.gleam", 2132).
-spec field(
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {FUS, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {field(FUS), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
field(Tokens, Parser) ->
    case Tokens of
        [{{name, Name}, Start}, {colon, End} | Tokens@1] ->
            case Tokens@1 of
                [{comma, _} | _] ->
                    {ok,
                        {{shorthand_field,
...
expression_unit(Tokens, Context) ->
    gleam@result:'try'(case Tokens of
            ...
            [{bang, {position, Start@13}} | Tokens@16] ->
                Unit = expression_unit(Tokens@16, regular_expression_unit),
                gleam@result:'try'(
                    Unit,
                    fun(_use0@2) ->
                        {Maybe_expression, Tokens@17} = _use0@2,
                        case Maybe_expression of
                            {some, Expression} ->
                                Span@4 = {span,
                                    Start@13,
                                    erlang:element(
                                ...
                                {ok,
                                    {{some, {negate_bool, Span@4, Expression}},
                                        Tokens@17}};

                            none ->
                                unexpected_error(Tokens@17)
                        end
                    end
                );

            [{minus, {position, Start@14}} | Tokens@18] ->
                Unit@1 = expression_unit(Tokens@18, regular_expression_unit),
                gleam@result:'try'(
                    Unit@1,
                    fun(_use0@3) ->
                        {Maybe_expression@1, Tokens@19} = _use0@3,
                        case Maybe_expression@1 of
                            {some, Expression@1} ->
                                Span@5 = {span,
                                    Start@14,
                                    erlang:element(
                                ...
                                {ok,
                                    {{some, {negate_int, Span@5, Expression@1}},
                                        Tokens@19}};
            ...
            [{echo, {position, Start@17}} | Tokens@24] ->
                Result@3 = case Context of
                    expression_unit_after_pipe ->
                        Span@6 = span_from_string(Start@17, <<"echo"/utf8>>),
                        {ok, {Span@6, none, Tokens@24}};

                    regular_expression_unit ->
                        gleam@result:map(
                            expression(Tokens@24),
                            fun(Expression_and_tokens) ->
                                {Expression@2, Tokens@25} = Expression_and_tokens,
                                Span@7 = {span,
                                    Start@17,
                                    erlang:element(
                                        3,
                                        erlang:element(2, Expression@2)
                                    )},
                                {Span@7, {some, Expression@2}, Tokens@25}
                            end
                        )
                end,
                gleam@result:'try'(
                    Result@3,
                    fun(_use0@6) ->
                        {Span@8, Echo_expression, Tokens@26} = _use0@6,
                        case Tokens@26 of
                            [{as, _} | Tokens@27] ->
                                gleam@result:map(
                                    expression(Tokens@27),
                                    fun(_use0@7) ->
                                        {Message, Tokens@28} = _use0@7,
                                        Span@9 = {span,
                                            erlang:element(2, Span@8),
                                            erlang:element(
                                                3,
                                                erlang:element(2, Message)
                                            )},
            ...
            {Parsed, Tokens@29} = _use0@8,
            case Parsed of
                {some, Expression@3} ->
                    case after_expression(Expression@3, Tokens@29) of
                        {ok, {Expression@4, Tokens@30}} ->
                            {ok, {{some, Expression@4}, Tokens@30}};
