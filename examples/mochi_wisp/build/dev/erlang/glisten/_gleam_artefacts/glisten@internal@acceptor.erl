...
-type pool(SHT, SHU) :: {pool,
        fun((SHT, glisten@internal@handler:loop_message(SHU), glisten@internal@handler:connection(SHU)) -> glisten@internal@handler:next(SHT, glisten@internal@handler:loop_message(SHU))),
        integer(),
        fun((glisten@internal@handler:connection(SHU)) -> {SHT,
            gleam@option:option(gleam@erlang@process:selector(SHU))}),
        gleam@option:option(fun((SHT) -> nil)),
        glisten@transport:transport()}.
