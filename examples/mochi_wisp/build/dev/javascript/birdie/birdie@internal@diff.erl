...
-type occurs(KOW) :: {one, integer(), list(KOW), list(KOW)} |
    {other, integer(), list(KOW), list(KOW)} |
    {both, integer(), list(KOW), list(KOW), list(KOW), list(KOW)}.
...
?DOC(false).
-spec sum_occurrences(occurs(KQD), occurs(KQD)) -> occurs(KQD).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(KPR, occurs(KPR)),
    list(KPR),
    fun((integer(), list(KPR), list(KPR)) -> occurs(KPR)),
    list(KPR)
) -> gleam@dict:dict(KPR, occurs(KPR)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(KPJ), list(KPJ)) -> gleam@option:option({KPJ,
    integer(),
    list(KPJ),
    list(KPJ),
    list(KPJ),
...
?DOC(false).
-spec do_pop_common_prefix(list(KQN), list(KQN), list(KQN)) -> {list(KQN),
    list(KQN),
    list(KQN)}.
...
?DOC(false).
-spec pop_common_prefix(list(KQH), list(KQH)) -> {list(KQH),
    list(KQH),
    list(KQH)}.
...
?DOC(false).
-spec pop_common_suffix(list(KQU), list(KQU)) -> {list(KQU),
    list(KQU),
    list(KQU)}.
...
?DOC(false).
-spec lcs(list(KPF), list(KPF)) -> list(KPF).
lcs(One, Other) ->
