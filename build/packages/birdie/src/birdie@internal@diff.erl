...
-type occurs(KLA) :: {one, integer(), list(KLA), list(KLA)} |
    {other, integer(), list(KLA), list(KLA)} |
    {both, integer(), list(KLA), list(KLA), list(KLA), list(KLA)}.
...
?DOC(false).
-spec sum_occurrences(occurs(KMH), occurs(KMH)) -> occurs(KMH).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(KLV, occurs(KLV)),
    list(KLV),
    fun((integer(), list(KLV), list(KLV)) -> occurs(KLV)),
    list(KLV)
) -> gleam@dict:dict(KLV, occurs(KLV)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(KLN), list(KLN)) -> gleam@option:option({KLN,
    integer(),
    list(KLN),
    list(KLN),
    list(KLN),
...
?DOC(false).
-spec do_pop_common_prefix(list(KMR), list(KMR), list(KMR)) -> {list(KMR),
    list(KMR),
    list(KMR)}.
...
?DOC(false).
-spec pop_common_prefix(list(KML), list(KML)) -> {list(KML),
    list(KML),
    list(KML)}.
...
?DOC(false).
-spec pop_common_suffix(list(KMY), list(KMY)) -> {list(KMY),
    list(KMY),
    list(KMY)}.
...
?DOC(false).
-spec lcs(list(KLJ), list(KLJ)) -> list(KLJ).
lcs(One, Other) ->
