...
-type occurs(KIX) :: {one, integer(), list(KIX), list(KIX)} |
    {other, integer(), list(KIX), list(KIX)} |
    {both, integer(), list(KIX), list(KIX), list(KIX), list(KIX)}.
...
?DOC(false).
-spec sum_occurrences(occurs(KKE), occurs(KKE)) -> occurs(KKE).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(KJS, occurs(KJS)),
    list(KJS),
    fun((integer(), list(KJS), list(KJS)) -> occurs(KJS)),
    list(KJS)
) -> gleam@dict:dict(KJS, occurs(KJS)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(KJK), list(KJK)) -> gleam@option:option({KJK,
    integer(),
    list(KJK),
    list(KJK),
    list(KJK),
...
?DOC(false).
-spec do_pop_common_prefix(list(KKO), list(KKO), list(KKO)) -> {list(KKO),
    list(KKO),
    list(KKO)}.
...
?DOC(false).
-spec pop_common_prefix(list(KKI), list(KKI)) -> {list(KKI),
    list(KKI),
    list(KKI)}.
...
?DOC(false).
-spec pop_common_suffix(list(KKV), list(KKV)) -> {list(KKV),
    list(KKV),
    list(KKV)}.
...
?DOC(false).
-spec lcs(list(KJG), list(KJG)) -> list(KJG).
lcs(One, Other) ->
