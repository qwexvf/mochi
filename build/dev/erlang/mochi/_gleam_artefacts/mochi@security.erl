...
-file("src/mochi/security.gleam", 171).
...
-file("src/mochi/security.gleam", 180).
...
-file("src/mochi/security.gleam", 189).
...
-file("src/mochi/security.gleam", 196).
...
-file("src/mochi/security.gleam", 265).
...
-file("src/mochi/security.gleam", 233).
...
-file("src/mochi/security.gleam", 280).
-spec count_aliases(
    mochi@ast:selection_set(),
    gleam@dict:dict(binary(), mochi@ast:fragment())
) -> integer().
...
-file("src/mochi/security.gleam", 310).
...
-file("src/mochi/security.gleam", 314).
-spec count_fields(
    mochi@ast:selection_set(),
    gleam@dict:dict(binary(), mochi@ast:fragment())
) -> integer().
...
-file("src/mochi/security.gleam", 95).
...
-file("src/mochi/security.gleam", 128).
