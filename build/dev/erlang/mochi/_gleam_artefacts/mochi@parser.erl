...
-file("src/mochi/parser.gleam", 374).
-spec token_as_name(mochi@lexer:token()) -> {ok, binary()} | {error, nil}.
token_as_name(Token) ->
    case Token of
        {name, Name} ->
            {ok, Name};
...
-file("src/mochi/parser.gleam", 433).
...
-file("src/mochi/parser.gleam", 426).
...
-file("src/mochi/parser.gleam", 129).
...
-file("src/mochi/parser.gleam", 145).
...
-file("src/mochi/parser.gleam", 389).
...
-spec parse_name_with_position(parser()) -> {ok,
        {binary(), mochi@lexer:position(), parser()}} |
    {error, parse_error()}.
parse_name_with_position(Parser) ->
    case consume_token(Parser) of
        {ok, {{token_with_position, Token, Position}, Parser@1}} ->
            case token_as_name(Token) of
                {ok, Name} ->
                    {ok, {Name, Position, Parser@1}};
...
-file("src/mochi/parser.gleam", 578).
...
-file("src/mochi/parser.gleam", 542).
...
-file("src/mochi/parser.gleam", 202).
        ...
        fun(_use0) ->
            ...
            case peek_token(Parser@1) of
                ...
                {ok, {token_with_position, left_brace, _}} ->
                    gleam@result:'try'(
                        parse_directives(Parser@1),
                        fun(_use0@5) ->
                            {Directives@1, Parser@6} = _use0@5,
                            gleam@result:'try'(
                                parse_selection_set(Parser@6),
                                fun(_use0@6) ->
                                    {Selection_set@1, Parser@7} = _use0@6,
                                    {ok,
                                        {{inline_fragment,
                                                {inline_fragment_value,
                                                    none,
                ...
                {ok, {token_with_position, {name, Name}, _}} ->
                    gleam@result:'try'(
                        ...
                        fun(_use0@7) ->
                            {_, Parser@8} = _use0@7,
                            gleam@result:'try'(
                                parse_directives(Parser@8),
                                fun(_use0@8) ->
                                    {Directives@2, Parser@9} = _use0@8,
                                    {ok,
                                        {{fragment_spread,
                                                {fragment_spread_value,
                                                    Name,
                                                    Directives@2}},
                                            Parser@9}}
                                end
...
-file("src/mochi/parser.gleam", 160).
...
-file("src/mochi/parser.gleam", 177).
...
-file("src/mochi/parser.gleam", 192).
...
-file("src/mochi/parser.gleam", 709).
...
-file("src/mochi/parser.gleam", 614).
...
-file("src/mochi/parser.gleam", 594).
...
-file("src/mochi/parser.gleam", 723).
...
-file("src/mochi/parser.gleam", 771).
...
-file("src/mochi/parser.gleam", 750).
...
-file("src/mochi/parser.gleam", 343).
...
-file("src/mochi/parser.gleam", 330).
...
-file("src/mochi/parser.gleam", 324).
                                ...
                                fun(_use0@3) ->
                                    ...
                                    gleam@result:'try'(
                                        ...
                                        fun(_use0@4) ->
                                            ...
                                            gleam@result:'try'(
                                                parse_selection_set(Parser@5),
                                                fun(_use0@5) ->
                                                    {Selection_set, Parser@6} = _use0@5,
                                                    {ok,
                                                        {{fragment,
                                                                Name,
                                                                Type_condition,
...
-file("src/mochi/parser.gleam", 270).
...
parse_field(Parser) ->
    gleam@result:'try'(
        parse_name_with_position(Parser),
        fun(_use0) ->
            {First_name, First_pos, Parser@1} = _use0,
            case peek_token(Parser@1) of
...
-file("src/mochi/parser.gleam", 505).
                                ...
                                fun(_use0@3) ->
                                    ...
                                    gleam@result:'try'(
                                        ...
                                        fun(_use0@4) ->
                                            ...
                                            gleam@result:'try'(
                                                parse_directives(Parser@5),
                                                fun(_use0@5) ->
                                                    {Directives, Parser@6} = _use0@5,
                                                    {ok,
                                                        {{variable_definition,
                                                                Name,
                                                                Var_type,
...
-file("src/mochi/parser.gleam", 488).
...
-file("src/mochi/parser.gleam", 465).
...
-file("src/mochi/parser.gleam", 94).
                                    ...
                                    gleam@result:'try'(
                                        ...
                                        fun(_use0@4) ->
                                            ...
                                            gleam@result:'try'(
                                                parse_selection_set(Parser@5),
                                                fun(_use0@5) ->
                                                    {Selection_set@1, Parser@6} = _use0@5,
                                                    {ok,
                                                        {{operation,
                                                                Op_type,
                                                                Name,
