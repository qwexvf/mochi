...
fn get_introspection_schema_type() -> schema.ObjectType {
  schema.ObjectType(
    ...
    fields: dict.from_list([
      ...
      #("types", make_introspection_field_list_non_null("types", "__Type")),
      #("queryType", make_introspection_field_non_null("queryType", "__Type")),
...
fn get_introspection_field_type() -> schema.ObjectType {
  schema.ObjectType(
    ...
    fields: dict.from_list([
      ...
      #("description", make_introspection_field("description", "String")),
      #("args", make_introspection_field_list_non_null("args", "__InputValue")),
...
fn get_introspection_input_value_type() -> schema.ObjectType {
  schema.ObjectType(
    ...
    fields: dict.from_list([
      ...
      #("isDeprecated", make_introspection_field("isDeprecated", "Boolean")),
      #(
        "deprecationReason",
        make_introspection_field("deprecationReason", "String"),
      ),
